...
# Based off https://colab.research.google.com/github/googlesamples/mediapipe/blob/main/tutorials/object_detection/Object_Detection_for_3_dogs.ipynb#scrollTo=35BJmtVpAP_n
# conda create -y --name py33 python==3.3.0

train_data = object_detector.Dataset.from_coco_folder("data/dataset", cache_dir="./data/od_data/train")
...
# parser.add_argument('--model-out', type=str, default='./data/model/', help='name of output model')
# parser.add_argument('--target', type=str, default='./data/model/', help='model output path (danger, could stop save)')
